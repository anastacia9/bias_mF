---
title: "sqrtPPR as a function of domain + 3' tAI, ensemble deltaG, and their interaction"
date: "3/15/2023"
...
#### sqrtPPR ~ domain3_tAI + deltaG + domain3_tAI:deltaG {.tabset .tabset-dropdown}
##### Menu
...
``` {r F1}
lmm0 <- lmer(sqrtPPR ~ tAI + ensembleG + tAI:ensembleG + (0+tAI:ensembleG|gene) + (0+tAI|medianPA) + (0+ensembleG|medianPA) + (0+tAI:ensembleG|medianPA) + (1|medianPA), data=dataset, REML = FALSE, control = lmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e5)))
summary(lmm0)
```
