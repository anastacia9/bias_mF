...
##### Read in tAI Data
```{r Ftai}
explanatory0 <- read.csv('C:/Users/anastacia/Desktop/tAI_linker_ramp_983_YRC_d.csv')
...
``` {r F1}
lmm0 <- lmer(logPPR ~ tAI + ensembleG + tAI:ensembleG + (0+tAI|gene) + (1|gene), data=dataset, REML = FALSE, control = lmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e5)))
summary(lmm0)
```
